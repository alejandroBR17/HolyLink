          ...
          <div className="flex items-center justify-between w-full lg:w-auto gap-3">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-xl overflow-hidden border border-amber-500/30 shadow-sm shrink-0 bg-zinc-900 flex items-center justify-center p-0.5">
                <img src="/icon-192.png?v=11" alt="HolyLink Símbolo" className="w-full h-full object-contain rounded-lg" />
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                <img src="/logo-text.png?v=11" alt="HolyLink Tipografia" className="h-6 w-[80px] object-cover object-center shrink-0" />
